    ...
    <div class="full-page-div">
        ...
        <div class="main-content-div mt-3">
            <div class="dashboard-header">
                <img src="ready-stock.png" class="p-1" style="width: 12%; height: auto" alt="dashboard.png">
                <h1>Stocks</h1>
            </div>
        ...
        <div class="add"><a href="#" class="btn btn-danger rounded-pill mx-auto d-flex align-items-center justify-content-center mt-0" style="width: 100%; height: 50px;">
                <img src="add.png" class="p-1" style="width: 40%; height: auto" alt="dashboard.png">Add</a></div>
